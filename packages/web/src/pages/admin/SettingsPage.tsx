      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {/* Logo upload */}
            <div className="space-y-2">
              <Label className="flex items-center gap-1.5"><Globe className="h-3.5 w-3.5" /> Blog logo <span className="text-xs text-muted-foreground font-normal">(square, e.g. 128 × 128 px)</span></Label>
              {logoPreview ? (
